...
DBM = {
	Revision = ("$Revision: 8009 $"):sub(12, -3),
	Version = "8.09",
	DisplayVersion = "8.09", -- the string that is shown as version
	ReleaseRevision = 8009 -- the revision of the latest stable version that is available (for /dbm ver2)
}
